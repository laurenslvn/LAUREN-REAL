...
def relationship_status(from_member, to_member, social_graph):
    ...
    def relationship_status(from_member, to_member, social_graph):
    if from_member in social_graph[to_member]["followers"] and to_member in social_graph[from_member]["followers"]:
        return "friends"
    elif from_member in social_graph[to_member]["followers"]:
        return "followed by"
    elif to_member in social_graph[from_member]["followers"]:
        return "follower"
    else:
        ...
        if from_stop == first_stop:
            ...
            if to_stop == second_stop:
                ...
                if remaining_time is not None:
                    return total_travel_time + remaining_time
