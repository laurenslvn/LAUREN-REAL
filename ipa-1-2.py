...
def savings(gross_pay, tax_rate, expenses):
    ...
    cents = round(gross_pay*tax_rate,0)
    after_tax_pay = gross_pay-cents
    final = after_tax_pay-expenses
    
    return int(final)

result = savings(113131313313, 0.12, 8080)
...
def body_mass_index(weight, height):
    ...
    height_1 = height[0] 
    height_2 = height[1]
    height_in_m_1 = height_1*0.3048
    height_in_m_2 = height_2*0.0254
    height_final = height_in_m_1+height_in_m_2
    bmi_total = weight_in_kg/(height_final*height_final)
    
    return bmi_total

body_mass_index(113.27, [5,9])
